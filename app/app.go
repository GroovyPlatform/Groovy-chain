...
import (
	...
	groovymodule "groovy/x/groovy"
	groovymodulekeeper "groovy/x/groovy/keeper"
	groovymoduletypes "groovy/x/groovy/types"
...
type App struct {
	*baseapp.BaseApp
	...
	GroovyKeeper groovymodulekeeper.Keeper
...
func New(
	...
	keys := sdk.NewKVStoreKeys(
		...
		groovymoduletypes.StoreKey,  wasmtypes.StoreKey,
	...
	*/
	...
	app.GroovyKeeper = *groovymodulekeeper.NewKeeper(
		appCodec,
		keys[groovymoduletypes.StoreKey],
		keys[groovymoduletypes.MemStoreKey],
		app.GetSubspace(groovymoduletypes.ModuleName),
	)
	groovyModule := groovymodule.NewAppModule(appCodec, app.GroovyKeeper, app.AccountKeeper, app.BankKeeper)
...
func initParamsKeeper(appCodec codec.BinaryCodec, legacyAmino *codec.LegacyAmino, key, tkey storetypes.StoreKey) paramskeeper.Keeper {
	...
	paramsKeeper.Subspace(groovymoduletypes.ModuleName)
